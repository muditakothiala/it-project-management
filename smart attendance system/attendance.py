...
class Attendance:
    def __init__(self, root):
        ...
        # second image
        img1 = Image.open(r"/Users/muditakothiala/Desktop/smart attendance system/images/image3.jpg")
        ...
        # bg image
        img3=Image.open(r"/Users/muditakothiala/Desktop/smart attendance system/images/image3.jpg")
        ...
        # left label frame
        Left_frame=LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE, text="Student Attendance Details", font=("times new roman", 12, "bold"), fg="#1e3a8a")
        ...
        # Right label frame
        Right_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE, text="Student Attendance Details", font=("times new roman", 12, "bold"), fg="#1e3a8a")
