...
class Student:
    def __init__(self, root):
        ...
        # First image
        img = Image.open(r"/Users/muditakothiala/Desktop/smart attendance system/images/image3.jpg")
        ...
        # Second image
        img1 = Image.open(r"/Users/muditakothiala/Desktop/smart attendance system/images/image1.jpg")
        ...
        # Third image
        img2 = Image.open(r"/Users/muditakothiala/Desktop/smart attendance system/images/image3.jpg")
        ...
        # Background image
        img3 = Image.open(r"/Users/muditakothiala/Desktop/smart attendance system/images/bg.jpeg")
        ...
        img_left = Image.open(r"/Users/muditakothiala/Desktop/smart attendance system/images/image3.jpg")
        ...
        # Department
        dep_label = Label(current_course_frame, text="Department", font=("times new roman", 12, "bold"), bg="#f9fafb", fg="#374151")
        ...
        # Entries
        StudentId_label = Label(class_student_frame, text="Student ID:", font=("times new roman", 12, "bold"), bg="#f9fafb", fg="#374151")
        ...
        save_btn = Button(btn_frame, text="Save", command=self.add_data, width=15, font=("times new roman", 13, "bold"),
                          bg="#2563eb", fg="#ffffff", activebackground="#1e40af")
        save_btn.grid(row=0, column=0, padx=10, pady=5)
        update_btn = Button(btn_frame, text="Update", command=self.update_data, width=15, font=("times new roman", 13, "bold"),
                            bg="#2563eb", fg="#ffffff", activebackground="#1e40af")
        update_btn.grid(row=0, column=1, padx=10, pady=5)
        delete_btn = Button(btn_frame, text="Delete", width=15, font=("times new roman", 13, "bold"),
                            bg="#2563eb", fg="#ffffff", activebackground="#1e40af")
        delete_btn.grid(row=0, column=2, padx=10, pady=5)
        reset_btn = Button(btn_frame, text="Reset", width=15, font=("times new roman", 13, "bold"),
                           bg="#2563eb", fg="#ffffff", activebackground="#1e40af")
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                con = mysql.connector.connect(host="localhost", username="root", password="Mudita#123", database="face_recognizer")
    ...
    # ========== Generate data set or Take photo Smamples =========
            ...
            try:
                ...
                my_cursor.execute(
                        ...
                        (self.var_dep.get(), self.var_course.get(), self.var_year.get(), self.var_semester.get(),
                         self.var_div.get(), self.var_roll.get(), self.var_gender.get(), self.var_dob.get(),
                         self.var_email.get(), self.var_phone.get(), self.var_address.get(), self.var_teacher.get(),
                         self.var_radio1.get(), self.var_std_id.get()==id+1)
                    )
                con.commit()
                self.fetch_data()
                self.reset_data()
    ...
    # ========== Load predefined datan face rontalsrom opencv =========
                ...
                while True:
                    ...
                    file_name_path = "/Users/muditakothiala/Desktop/smart attendance system/data." + str(id) + "." + str(img_id) + ".jpg"
